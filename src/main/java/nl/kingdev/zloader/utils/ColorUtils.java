package nl.kingdev.zloader.utils;
...
public class ColorUtils {
    ...
    public static String getHexName(Color color)
    {
        ...
        return (rHex.length() == 2 ? rHex : new StringBuilder("0").append(rHex).toString()) + (gHex.length() == 2 ? gHex : new StringBuilder("0").append(gHex).toString()) + (bHex.length() == 2 ? bHex : new StringBuilder("0").append(bHex).toString());
    }
